...
func readTemplate(templates []string, templateDir string) ([]TemplateBlog, error) {
	...
	for _, view := range templates {
		...
		header1 := templateDir + "/layout/header1.html"
		...
		t, err := t.ParseFiles(templateDir+viewName, home, header, header1, footer, post, pagination)
		if err != nil {
